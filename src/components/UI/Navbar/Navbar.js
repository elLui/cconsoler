        ...
        <nav className="navbar">
            ...
            <div className="nav-menu">
                <ul className="nav-menu-list">
                    ...
                    <li className="nav-menu-listItem"><a href="/contact" className="nav-menu-anchor">contact</a></li>
                    <li className="nav-menu-listItem"><a href="/links" className="nav-menu-anchor">links</a></li>
                    <li className="nav-menu-listItem"><a href="/resources" className="nav-menu-anchor">resources</a></li>
                </ul>
            </div>
        </nav>
    )
